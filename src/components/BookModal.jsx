  ...
  return (
    ...
    >
      ...
      >
        ...
        <p><strong>Количество страниц:</strong> {book.numberOfPages}</p>
        <p><strong>Издатель:</strong> {book.publisher}</p>
        <p><strong>Страна:</strong> {book.country}</p>
        <p><strong>Тип издания:</strong> {book.mediaType}</p>
        <p><strong>Дата выпуска:</strong> {new Date(book.released).toDateString()}</p>
      </div>
    </div>
  );
}
